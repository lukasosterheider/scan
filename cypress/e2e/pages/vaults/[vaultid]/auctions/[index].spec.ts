context("/vaults/[vaultid]/auctions/[index] on desktop", () => {
  before(() => {
    cy.request('https://ocean.explore-defichain.com/v0/mainnet/loans/auctions?size=1')
  ...
  it("should have heading", () => {
    cy.findByTestId("AuctionDetails.Heading")
      .should("be.visible")
      .should("have.text", "Auction Details");
  });

  it("should have Auction Details", () => {
    ...
    cy.findByTestId("DesktopAuctionDetails.BatchNumber")
      .should("be.visible")
      .contains(/^BATCH #\d+$/);
    cy.findByTestId("DesktopAuctionDetails.AuctionTimeLeft")
      .should("be.visible")
      .contains(/^~.* left$/);

    cy.findAllByTestId("DesktopAuctionDetails.MinNextBid").within(() => {
      cy.findByTestId("DesktopAuctionDetails.MinNextBid.Label")
        .should("be.visible")
        .should("have.text", "Min. Next Bid");
      cy.findByTestId("BidAmountValue.MinBidAmount")
        .should("be.visible")
    ...
    cy.findAllByTestId("DesktopAuctionDetails.MinStartingBid").within(() => {
      cy.findByTestId("DesktopAuctionDetails.MinStartingBid.Label")
        .should("be.visible")
        .should("have.text", "Min. Starting Bid");
      cy.findByTestId("BidAmountValue.MinBidAmount")
        .should("be.visible")
        .contains(/^\d{1,3}(,\d{3})*(\.\d+) [a-zA-Z]+$/);
      cy.findByTestId("BidAmountValue.MinBidValue")
    ...
    cy.findAllByTestId("DesktopAuctionDetails.VaultID").within(() => {
      cy.findByTestId("DesktopAuctionDetails.VaultID.Label")
        .should("be.visible")
    ...
    cy.findAllByTestId("DesktopAuctionDetails.CollateralsForAuctions").within(
      () => {
        cy.findByTestId("DesktopAuctionDetails.CollateralsForAuctions.Label")
          .should("be.visible")
...
context("/vaults/[vaultid]/auctions/[index] on mobile", () => {
  ...
  it("should have Auction Details", () => {
    ...
    cy.findByTestId("MobileAuctionDetails.BatchNumber")
      .should("be.visible")
      .contains(/^BATCH #\d+$/);
    cy.findByTestId("MobileAuctionDetails.AuctionTimeLeft")
      .should("be.visible")
      .contains(/^~.* left$/);

    cy.findAllByTestId("MobileAuctionDetails.MinNextBid").within(() => {
      cy.findByTestId("MobileAuctionDetails.MinNextBid.Label")
        .should("be.visible")
        .should("have.text", "Min. Next Bid");
      cy.findByTestId("BidAmountValue.MinBidAmount")
        .should("be.visible")
    ...
    cy.findAllByTestId("MobileAuctionDetails.MinStartingBid").within(() => {
      cy.findByTestId("MobileAuctionDetails.MinStartingBid.Label")
        .should("be.visible")
        .should("have.text", "Min. Starting Bid");
      cy.findByTestId("BidAmountValue.MinBidAmount")
        .should("be.visible")
    ...
    cy.findAllByTestId("MobileAuctionDetails.VaultID").within(() => {
      cy.findByTestId("MobileAuctionDetails.VaultID.Label")
        .should("be.visible")
        .should("have.text", "Vault ID");
    ...
    cy.findAllByTestId("MobileAuctionDetails.CollateralsForAuctions").within(
      () => {
        cy.findByTestId("MobileAuctionDetails.CollateralsForAuctions.Label")
          .should("be.visible")
          .should("have.text", "Collaterals For Auction");
